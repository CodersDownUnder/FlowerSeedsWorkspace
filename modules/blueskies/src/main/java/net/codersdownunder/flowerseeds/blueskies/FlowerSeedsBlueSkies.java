package net.codersdownunder.flowerseeds.blueskies;
...
@Mod(FlowerSeedsBlueSkies.MODID)
public class FlowerSeedsBlueSkies {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "flowerseedsblueskies";
    ...
    public static final DeferredBlock<Block> Test_SEED = registerBlock("test_seed",
    ...
    public FlowerSeedsBlueSkies(IEventBus modEventBus) {
